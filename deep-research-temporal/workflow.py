        ...
        while round_num < inp.max_rounds and round_num < abs_cap and directions:
            ...
            for d in current_batch:
                ...
                await _write(p,
                    ...
                    "- When referencing people, verify they are current (check Pandora if available)\n"
                    ...
                    "- Search Google Docs/Slides explicitly via netflix_search_api with "
                    "sources=[\"GOOGLE_DOCS\",\"GOOGLE_SLIDES\"] — strategy docs, "
                    "architecture specs, and roadmaps live there, not in Manuals or Slack\n"
                    "- Also search [\"MANUAL\",\"SLACK\",\"CONFLUENCE\"] for operational context\n"
                    "- Fetch full content of high-value docs via netflix_search_data\n\n"
            ...
            _researcher_system = (
                ...
                "repos, teams, people, PRs, incidents. Verify people are current via "
                "Pandora when possible. Include industry comparisons. Full clickable URLs.\n"
                "SOURCES: Always search GOOGLE_DOCS + GOOGLE_SLIDES via netflix_search_api "
                "in addition to MANUAL + SLACK + CONFLUENCE. Fetch full content of "
                "high-value docs via netflix_search_data.\n"
                "STRUCTURED_OUTPUT_START\n"
