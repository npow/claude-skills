        ...
        while round_num < inp.max_rounds and round_num < abs_cap and directions:
            ...
            for d in current_batch:
                ...
                await _write(p,
                    ...
                    "evidence.\n\n"
                    "IMPORTANT: Search Google Docs and Slides explicitly — strategy "
                    "docs, architecture specs, tech specs, and roadmaps live there, "
                    "not in Manuals or Slack. Use netflix_search_api with "
                    "sources=[\"GOOGLE_DOCS\",\"GOOGLE_SLIDES\"] in addition to "
                    "[\"MANUAL\",\"SLACK\"]. Fetch full content of key docs via "
                    "netflix_search_data.\n\n"
            ...
            _researcher_system = (
                ...
                "CRITICAL: When using netflix_search_api, search MULTIPLE source types "
                "per query. Strategy docs, architecture specs, and roadmaps live in "
                "Google Docs/Slides, NOT in Manuals or Slack. Always include at least "
                "one search with sources=[\"GOOGLE_DOCS\",\"GOOGLE_SLIDES\"] and one "
                "with sources=[\"MANUAL\",\"SLACK\",\"CONFLUENCE\"]. Use "
                "netflix_search_data to fetch full content of high-value Google Docs.\n"
                "STRUCTURED_OUTPUT_START\n"
